...
发布回归执行 `node --check src/background.js`、`node --check src/sidepanel.js` 和 `npm test`，结果为 460/460 通过。显式白名单 ZIP 连续构建两次均为 37 个文件，SHA-256 都是 `e71d3e6d538bfefcd89c39d00a1a4748fcd45fc98215a84ce6b56a4e8e289981`，完整性检查通过。发布包不包含测试、文档、开发脚本或本地凭据。
